...
extension SkeletonCell {
    private func setup() {
        ...
        underlineView.backgroundColor = appContainer.theme.appColor
        ...
        let chevronImage = UIImage(systemName: "chevron.right")!.withTintColor(appContainer.theme.appColor, renderingMode: .alwaysOriginal)
